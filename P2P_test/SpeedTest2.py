...
if __name__ == '__main__':
    ...
    E = PClient(tracker_address, upload_rate=100000, download_rate=100000, name='E')
    F = PClient(tracker_address, upload_rate=100000, download_rate=100000, name='F')
    G = PClient(tracker_address, upload_rate=100000, download_rate=100000, name='G')
    H = PClient(tracker_address, upload_rate=100000, download_rate=100000, name='H')
    ...
    rates = [100000, 100000, 100000, 100000, 100000, 100000, 100000]
    threads.clear()
